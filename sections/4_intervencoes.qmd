...
```{r dag intevention 1 img, fig.width=5, fig.height=4, fig.align='center', echo=FALSE, message=FALSE, warning=FALSE}
x <- 10
...
```{r dag intevention 2 code,echo = TRUE, fig.show='hide', message=FALSE, warning=FALSE}
x <- 10
